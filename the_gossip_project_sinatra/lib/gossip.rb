...
class Gossip
  attr_accessor :author , :content
    ...
    def save
      CSV.open("/Users/crvckhouse/Desktop/the_gossip_project_sinatra/db/gossip.csv", "ab") do |csv|
    csv << [author,content]
  end
    end
    ...
    def self.all
  all_gossips = []
  CSV.read("/Users/crvckhouse/Desktop/the_gossip_project_sinatra/db/gossip.csv").each do |csv_line|
